...
@section('title')Manage Parliament @endsection
@section('css')
...
@section('body-start') <body id="body" class="dark-sidebar" data-layout="horizontal"> @endsection
    ...
    @slot('title') Parliament Types @endslot
    @endcomponent
    @endsection
    <div class="card">
...
<div class="row">
    <div class="col-lg-12 margin-tb">
        <div class="pull-left">
            <h2>Manage Parliament</h2>
        </div>
        <div class="pull-right">
            <a class="btn btn-danger" href="{{ route('parliaments.create') }}"> Create New Parliament</a>
        </div>
    </div>
</div>
...
<div class="card-body">
 ...
 <tr>
   <th>No</th>
   <th>Parliament Type</th>

   <th width="280px">Action</th>
 </tr>
</thead>
 @foreach ($data as $key => $parliament)
  <tr>
    <td>{{ ++$i }}</td>
    <td>{{ $parliament->type }}</td>
