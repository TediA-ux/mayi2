...
@section('title')Professional Body @endsection
@section('css')
...
@section('body-start') <body id="body" class="dark-sidebar" data-layout="horizontal"> @endsection
    ...
    @slot('title') Professional Body @endslot
    @endcomponent
    @endsection
    <div class="card">
...
<div class="row">
    <div class="col-lg-12 margin-tb">
        <div class="pull-left">
            <h2>Edit Professional Body</h2>
        </div>
        <div class="pull-right">
            <a class="btn btn-primary" href="{{ route('professional-bodies.index') }}"> Back</a>
        </div>
    </div>
</div>
...
{!! Form::model($professional_body, ['method' => 'PATCH','route' => ['professional-bodies.update', $professional_body->id]]) !!}
<div class="row">
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group">
            <strong>Name:</strong>
            {!! Form::text('name', null, array('placeholder' => 'Enter Professional Body','class' => 'form-control')) !!}
        </div>
    </div>
