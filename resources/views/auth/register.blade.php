                            ...
                            <div class="card">
                                <div class="card-body p-0 auth-header-box">
                                    <div class="text-center p-3">
                                        ...
                                        <h4 class="mt-3 mb-1 fw-semibold text-white font-18">Let's Get Started Code 316</h4>
                                        <p class="text-muted  mb-0">Sign up to continue to Code 316.</p>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group row mt-3">
                                            <div class="col-12">
                                                <div class="form-check form-switch form-switch-success">
                                                    ...
                                                    <label class="form-check-label" for="customSwitchSuccess">By registering you agree to the Code 316 <a href="#" class="text-primary">Terms of Use</a></label>
                                                </div>
                                            </div>
                                            <!--end col-->
                                        </div>
