...
@section('title')Profession @endsection
@section('css')
...
<div class="row">
    <div class="col-lg-12 margin-tb">
        ...
        <div class="pull-right">
            <a class="btn btn-primary" href="{{ route('professions.index') }}"> Back</a>
        </div>
    </div>
</div>
...
{!! Form::model($profession, ['method' => 'PATCH','route' => ['professions.update', $profession->id]]) !!}
<div class="row">
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group">
            <strong>Name:</strong>
            {!! Form::text('name', null, array('placeholder' => 'Enter Profession','class' => 'form-control')) !!}
        </div>
    </div>
