...
class DailyGiving extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'giving:daily';
     ...
     * @var string
     */
    protected $description = 'Respectively execute daily giving via api.';
    ...
    public function handle()
    {
        ...
        $users = User::select('users.*','scheduling.amount AS gamount','scheduling.category','scheduling.comment','scheduling.phone_number')->join('scheduling','scheduling.userid','users.id')->where('scheduling.type','daily')->get();
        ...
        $this->info('Successfully executed daily giving.');
