...
class WeeklyGiving extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'giving:weekly';
     ...
     * @var string
     */
    protected $description = 'Respectively execute weekly giving via api.';
    ...
    {
        $users = User::select('users.*','scheduling.amount AS gamount','scheduling.category','scheduling.comment','scheduling.phone_number')->join('scheduling','scheduling.userid','users.id')->where('scheduling.type','weekly')->get();
        ...
        $this->info('Successfully executed weekly giving.');
    }
}
