...
class GivingExport implements FromView
{
    ...
    public function view(): View
    {
        ...
        if (isset($this->user_id)) {
            ...
            $datas->where('givings.user_id', $this->user_id);
        }

        if (isset($this->type)) {

            $datas->where('givings.type', $this->type);
        }

        if (isset($this->category)) {

            $datas->where('givings.category', $this->category);
        }
        ...
        return view('reports.givingsexcel', [
